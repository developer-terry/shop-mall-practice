...
import com.practice.shopmall.ware.feign.MemberFeignService;
import com.practice.shopmall.ware.vo.FareVo;
import com.practice.shopmall.ware.vo.MemberRecieveAddressVo;
...
import com.practice.shopmall.ware.dao.WareInfoDao;
import com.practice.shopmall.ware.entity.WareInfoEntity;
import com.practice.shopmall.ware.service.WareInfoService;
...
public class WareInfoServiceImpl extends ServiceImpl<WareInfoDao, WareInfoEntity> implements WareInfoService {
    ...
    public FareVo getFare(Long addrId) {
        ...
        MemberRecieveAddressVo data = r.getData("memberRecieveAddress", new TypeReference<MemberRecieveAddressVo>() {
        });
